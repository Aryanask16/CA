...
const RightPanel: NextPage<RightPanelType> = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 pb-[30.5px] pr-[21px] pl-5 box-border max-w-full text-center text-35xl text-midnightblue-100 font-satoshi-variable ${className}`}
    >
      <div className="w-[1231px] flex flex-row items-start justify-between max-w-full gap-[20px] lg:flex-wrap">
        ...
        <div className="w-[498px] flex flex-row items-start justify-start gap-[12px] min-w-[498px] max-w-full text-xs text-darkslateblue font-dm-sans lg:flex-1 mq450:flex-wrap mq750:min-w-full">
          <ThreeDCardDemo />
          <div className="flex-1 flex flex-col items-start justify-start gap-[12px] min-w-[248px] max-w-full">
            ...
            <div className="self-stretch flex flex-row items-start justify-center gap-[14px] mq450:flex-wrap">
              <ThreeDCardDemo5 />
